...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <div id="loading"></div>
    ...
    <br>
    <h2 style="font-size:35px;"> Update Games </h2> <br>
        <form class="row g-3" method="post" action="/updateGame">
        {{csrf_field()}}
        ...
        <input type="hidden" name="id" value="{{$data->id}}">
            ...
            <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="gameType" value="{{$data->gametype}}" readonly required>
            </div> 

            <div class="form-group">
                <label class="form-label"> <b> Game </b> </label>
                <textarea class="form-control rounded-0" rows="10" name="game" id='editor'>{{$data->game}}</textarea>
              </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="answerA" value="{{$data->answerA}}" required>
           </div> 

            <div class="form-group">
                <label><b> Answer B </b></label>
                <input type="text" class="form-control" name="answerB"  value="{{$data->answerB}}" required>
            </div>

            <div class="form-group">
                <label> <b> Answer C </b></label>
                <input type="text" class="form-control" name="answerC"  value="{{$data->answerC}}">
            </div>

            <div class="form-group">
                <label> <b> Answer D </b></label>
                <input type="text" class="form-control" name="answerD"  value="{{$data->answerD}}">
            </div>

            <div class="form-group">
                <label> <b> Correct Answer </b> </label>
                <input type="text" class="form-control" name="correctAnswer" value="{{$data->correctAnswer}}" required>
            </div>

            <div class="col-12">
                <button class="btn btn-success" type="submit">Update Game</button>
