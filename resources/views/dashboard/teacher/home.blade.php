...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KyZXEAg3QhqLMpG8r+8fhAXLRk2vvoC2f3B09zVXn8CA5QIVfZOJ3BCsw2P0p/We" crossorigin="anonymous">
    ...
    background-image: url('/images-p/image3.jpg');
...
<nav class="navigaation-bar background-dark">
    ...
    <div class="container">
        <div class="row">
            ...
            <br>
            <br>
                <center> <h4><b>Teacher Dashboard</b></h4></center>
                <br>
                <br>
                 <table class="table table-striped table-inverse table-responsive">
                     <thead class="thead-inverse">
                         ...
                         <tbody>
                         <tr>
                                 <td scope="row">{{ Auth::guard('teacher')->user()->fullname }}</td>
                                 <td>{{ Auth::guard('teacher')->user()->address }}</td>
                                 <td>{{ Auth::guard('teacher')->user()->email }}</td>
                                 <td>{{ Auth::guard('teacher')->user()->education }}</td>
                                 <td>{{ Auth::guard('teacher')->user()->skills }}</td>
                                 <td>
                                     <a href="{{ route('teacher.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><b>Logout</b></a>
