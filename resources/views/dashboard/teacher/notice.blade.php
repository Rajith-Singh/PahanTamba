...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <style>
    body {
    background-image: url('/images-p/123.jpg');
  ...
  <div class="container mt-5 m-auto">  
    <br>
    <center><h2 style="font-size:35px;"> Add Notice </h2></center> <br>
    <form class="row g-3" method="post" action="/saveNotice">
        {{csrf_field()}}
        ...
        @endif
            ...
            <div class="col-md-6">
                ...
                <select class="form-select" name="diseasesLevel">
                    <option selected disabled value="">Choose...</option>
                    <option> Level 1 </option>
                    <option> Level 2 </option>
                    <option> Level 3 </option>
                </select>
                <span style="color:red"> @error('diseasesLevel'){{$message}}@enderror</span>
            </div>
            <br>
            <div class="col-md-6">
                <label class="form-label"> <b> Diseases Class </b> </label>     
                <select class="form-select" name="diseasesClass">
                    <option selected disabled value="">Choose...</option>
                    <option> Autism </option>
                    <option> Down syndrome </option>
                    <option> Hyperactive </option>
                </select>
                <span style="color:red"> @error('diseasesClass'){{$message}}@enderror</span>
            </div>

            <div class="form-group">
                <label class="form-label"> <b> Message </b> </label>
                <textarea class="form-control rounded-0" rows="10" name="message" id='editor'></textarea>
