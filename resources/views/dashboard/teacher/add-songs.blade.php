...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <div class="container mt-5 m-auto">  
    <br>
    <h2 style="font-size:35px;"> Add Songs </h2> <br>
        <form class="row g-3" method="post" action="/teacher/storeSong">
        {{csrf_field()}}
        ...
        @endif
            ...
            <div class="form-group">
                ...
                <textarea class="form-control rounded-0" rows="10" name="song" id='editor'></textarea>
