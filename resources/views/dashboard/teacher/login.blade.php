    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4" style="margin-top: 45px;">
                <br>
                <br>
                  <center><h4><b>Teacher Login</b></h4></center>
                    <br>
                  <form action="{{ route('teacher.check') }}" method="post" autocomplete="off">
                    ...
                    @csrf
                      ...
                      <br>
                      <a href="{{ route('teacher.forgot.password.form') }}">Forgot password</a>
                      <br>
                      <br>
                      <div class="form-group">
                      ...
                      <br>
                      <a href="{{ route('teacher.register') }}"><b><i>Create new Account</i></b></a>
                      <br>
