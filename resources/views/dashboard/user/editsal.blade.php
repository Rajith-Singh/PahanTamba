		...
		<div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav m-auto">
	        	...
	        	<li class="nav-item active"><a href="#" class="nav-link">Finance</a></li>
    ...
    <h2> Add Salary </h2>
        ...
        @endif
            ...
            <div class="col-md-6">
                ...
                <span style="color:red"> @error('teacherClass'){{$message}}@enderror</span>
                <br><br>
            </div>   
            ...
            <div class="col-md-6">
                ...
                <span style="color:red"> @error('classLevel'){{$message}}@enderror</span>
                <br><br>
            </div>      
