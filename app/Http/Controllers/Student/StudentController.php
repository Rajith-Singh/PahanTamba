...
class StudentController extends Controller
{
    function create(Request $request){
          ...
          $request->validate([
             ...
             'diseasestype'=>'required',
             'diseaseslevel'=>'required',
             'doctorrecommendationletter'=>'required',
             'name'=>'required',
             'mobilenumber'=>'required',
             'employeeornot'=>'required'
          ...
          $student->diseasestype = $request->diseasestype;
          $student->diseaseslevel = $request->diseaseslevel;
          $student->doctorrecommendationletter = $request->doctorrecommendationletter;
          $student->name = $request->name;
          $student->mobilenumber = $request->mobilenumber;
          $student->employeeornot = $request->employeeornot;
